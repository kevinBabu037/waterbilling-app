...
import 'package:super_admin_app/application/screens/supervisor/widget/supervisor.dart';
...
class ScreenSupervisor extends StatelessWidget {
  const ScreenSupervisor({super.key});

  @override
  Widget build(BuildContext context) {
    context.read<ZoneBloc>().add(GetAllZonesEvent());
    return Scaffold(
      appBar: AppBar(title:const Text("Supervisor Mnagement"),),
      body: SizedBox(
                ...
                return ListView.separated(
                    itemBuilder: (context, index) {
                      ...
                      return  ListTile( 
                        ...
                        onTap: () => kNavigationPush(context,AddSuperVisor(zone: zone,)),
