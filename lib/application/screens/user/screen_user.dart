...
import 'package:super_admin_app/application/screens/user/widget/subzones.dart';
...
class ScreenUser extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title:const Text("User Mnagement"),),
      body: SizedBox(
                ...
                return ListView.separated(
                    itemBuilder: (context, index) {
                      ...
                      return  ListTile( 
                        ...
                        onTap: () => kNavigationPush(context,SubzonesUser(zone: zone,)),
