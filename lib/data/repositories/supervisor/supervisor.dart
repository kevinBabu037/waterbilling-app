...
class SupervisorService {
  ...
  Future<bool> addSubSupervisor(Supervisor supervisorModel) async {
    final url = Uri.parse('${EndPoint.baseUrl}${EndPoint.addSupervisor}');
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode(supervisorModel.toJson()), 
      ); 
